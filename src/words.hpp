...
// thanks
// https://github.com/monkeytypegame/monkeytype/blob/bf9e53355ffae838c99f2a54577ed8ba86de663a/frontend/static/languages/english.json

std::vector<std::string> words = {
    "the",      "be",      "of",       "and",     "a",       "to",      "in",       "he",
    "have",     "it",      "that",     "for",     "they",    "I",       "with",     "as",
    "not",      "on",      "she",      "at",      "by",      "this",    "we",       "you",
    "do",       "but",     "from",     "or",      "which",   "one",     "would",    "all",
    "will",     "there",   "say",      "who",     "make",    "when",    "can",      "more",
    "if",       "no",      "man",      "out",     "other",   "so",      "what",     "time",
